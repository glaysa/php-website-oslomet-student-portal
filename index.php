...
<div id="cover-container" class="container-fluid">
    <section id="cover-entry" class="container d-flex flex-lg-row flex-column">
        ...
        <div class="order-lg-2 order-1">
            <img src="assets/images/cover-side-image.png" alt="cover image" id="cover-img" class="img-fluid">
        </div>
    </section>
</div>
